...
stopWordsOutFile = 'src/main/resources/stopwords-arxiv-metadata-oai-snapshot-lite.json'
tokensOutFile = 'src/main/resources/tokens-arxiv-metadata-oai-snapshot-lite.json'
